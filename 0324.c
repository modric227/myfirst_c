...
// 정수
// 각 자료형의 차이는 차지하는 공간
// 공간의 크기차이는 저장할 수 있는 숫자의 범위의 차이가 된다.
// int       : 4 byte   -- -20억 ~ 20억
// short     : 2 byte   -- -3만  ~ 3만
// long      : 4 byte   
...
// 만약, 어떤 정수를 나타내는 데이터 타입이 1 byte = (8bit) 라면, 
// 표현가능한 숫자 범위는?

// 2개 bit가 있으면, 00, 01, 10, 11                  (2^2)
//                    0   1  -2  -1                  (2^(2-1) ~ 2^(2-1)-1)   --> 4가지 숫자 표현 가능
//                    0   1   2   3                  (0~ 2^2-1)
...
//
//        양수 <--> 음수
//             비트를 모두 toogle (on-> off, off-> on)
//             +1
//
//       양수 1 --> 001 (이진수)
//       2의 보수를 이용해서 음수 -1을 만들어 보자
//       001 -- toogle --> 110 --> +1 --> 111 (음수 1)
//   -1  111 -- toogle --> 000 --> +1 --> 001
//
//       음의 0을 없애버렸음
//       000 (양의 0) --> 111 --> 000 
//
...
// floating point number <--- 이름의 유래를 알아보자

// 옛날 옛적에, fixed point nmber (고정소수점형)
//     소수점을 가진 숫자를 표현하는 방법
